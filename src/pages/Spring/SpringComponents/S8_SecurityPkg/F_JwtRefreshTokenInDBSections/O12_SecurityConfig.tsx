      ...
      <section className="my-8">
        ...
        <ULdisc>
          <Li>
            🔑 GitHub project link ⇨{" "}
            <Anchor
              description="O4-jwt-refresh-token-DB - SecurityConfig"
              href="https://github.com/sshalem/Spring-Boot/blob/main/08-Spring-Security/03_JWT/O4-jwt-refresh-token-DB/src/main/java/com/backend/config/SecurityConfig.java"
            ></Anchor>{" "}
          </Li>
        </ULdisc>
      </section>
...
const jwt_security_config_dsl_lambda = `package com.backend.config;
