    ...
    <MainChildArea anchor={anchor}>
      <ULdisc>
        <Li>
          🔑 GitHub project link ⇨ &nbsp;
          <Anchor
            description="O4-jwt-refresh-token-DB - POM & Dependencies"
            href="https://github.com/sshalem/Spring-Boot/blob/main/08-Spring-Security/03_JWT/O4-jwt-refresh-token-DB/pom.xml"
          ></Anchor>
        </Li>
      </ULdisc>
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<artifactId>O4-jwt-refresh-token-DB</artifactId>
	<version>0.0.1-SNAPSHOT</version>
	<name>O4-jwt-refresh-token-DB</name>
	<description>Demo JWT refresh token DB</description>
	<url/>
	<licenses>
		<license/>
	</licenses>
