...
const O6_Service = ({ anchor }: { anchor: string }) => {
  ...
  const renderRefreshTokenServiceImpl = useMemo(() => <JavaHighlight javaCode={refresh_token_service_impl} />, [refresh_token_service_impl]);
  ...
  return (
    <MainChildArea anchor={anchor}>
      <section className="my-8">
        ...
        <ULdisc>
          <Li>
            🔑 GitHub project link ⇨{" "}
            <Anchor
              description="O4-jwt-refresh-token-DB - service"
              href="https://github.com/sshalem/Spring-Boot/tree/main/08-Spring-Security/03_JWT/O4-jwt-refresh-token-DB/src/main/java/com/backend/service"
            ></Anchor>{" "}
          </Li>
        </ULdisc>
      </section>
      <hr />
      <section className="my-8">
        <p className="my-4 text-lg font-semibold">🧩 Service Layer</p>
        <article>
      ...
      <hr />
      <section className="my-8">
        <p className="my-4 text-lg font-semibold">🧩 RefreshTokenServiceImpl</p>
        {renderRefreshTokenServiceImpl}
      </section>
    </MainChildArea>
  );
};
...
const user_service_impl = `package com.backend.service;
...
const role_service_impl = `package com.backend.service;
