        ...
        <article>
          ...
          <div className="my-4">
            <ULDecimal>
              ...
              <JavaHighlight javaCode={generated_sql}></JavaHighlight>
            </ULDecimal>
          </div>
        </article>
      </section>
...
const generated_sql = `-- Paginated query -- 
...
const native_count_query = `@Query(value = "SELECT * FROM student s WHERE s.age > :age ORDER BY s.name ASC",
