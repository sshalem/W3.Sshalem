...
const O3_QuerySingleEntityTable = ({ anchor }: { anchor: string }) => {
  return (
    <MainChildArea anchor={anchor}>
      <section>
        <div>
          ...
          <ULDecimal>
            <Li>
              <SpanGrey>UserEntity</SpanGrey> Class name is used with <SpanTeal>JPQL</SpanTeal>
            </Li>
            <Li>
              <SpanGrey>USERS_TB</SpanGrey> Table name is used with <SpanSky>Native SQL</SpanSky>
            </Li>
          </ULDecimal>
        </div>
...
export default O3_QuerySingleEntityTable;
