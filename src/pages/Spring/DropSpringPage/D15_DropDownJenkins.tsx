...
const D15_DropDownJenkins = () => {
  ...
  return (
    <section>
      <SideDropDownTopic showList={showList} handleOpenList={handleOpenList} internalLink="/spring/jenkins" topicName="15. Jenkins (CI/CD)" />
...
export default D15_DropDownJenkins;
