...
const DropDownSpringIO = () => {
  ...
  return (
    <section>
      <SideDropDownTopic showList={showList} handleOpenList={handleOpenList} internalLink="/spring/io" topicName="Spring IO" />
...
export default DropDownSpringIO;
