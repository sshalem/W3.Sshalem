  ...
  return (
    <section>
      ...
      >
        ...
        <SideDropdownLink sideDropDownNavName="Refresh Token (Stateless)" internalLink="/spring/security/jwt-refresh-token-stateless" />
        <SideDropdownLink sideDropDownNavName="Refresh Token (DB) Rotation" internalLink="/spring/security/jwt-refresh-token-in-DB" />
        <SideDropdownLink sideDropDownNavName="Refresh Token (DB) HttpOnly" internalLink="/spring/security/jwt-refresh-token-httpOnly" />
