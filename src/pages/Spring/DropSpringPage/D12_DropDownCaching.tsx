...
const D12_DropDownCaching = () => {
  ...
  return (
    <section>
      <SideDropDownTopic showList={showList} handleOpenList={handleOpenList} internalLink="/spring/caching" topicName="12. Cache" />
...
export default D12_DropDownCaching;
