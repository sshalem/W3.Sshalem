...
const FastAPIHome = () => {
  return (
    <div>
      <div className="bg-blue-500 p-4 font-mono text-4xl font-semibold tracking-wider text-white">FastAPI Home ...</div>
      <section className="my-8">
        <article className="my-4 text-xl font-semibold">✅ What is FastAPI?</article>
        <ULdisc>
          <Li>
            FastAPI is a modern, fast (high-performance), <SpanGrey>web framework</SpanGrey> for building APIs with Python based on standard Python
            type hints.
          </Li>
      ...
      <section className="my-8">
        ...
        <ULdisc>
          ...
          <Li>
            <strong>user_router.py</strong> like <SpanGrey>UserController</SpanGrey> with annotation <SpanGrey>@RestController</SpanGrey> in spring
            boot
