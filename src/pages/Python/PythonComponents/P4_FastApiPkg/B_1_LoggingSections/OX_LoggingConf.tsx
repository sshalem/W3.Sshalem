...
const OX_LoggingConf = ({ anchor }: { anchor: string }) => {
  return (
    <MainChildArea anchor={anchor}>
      <section className="my-8">
        ...
        <article className="my-8 text-lg font-semibold">Sample logging.conf (INI format — works for Uvicorn)</article>
        <div>✅ Notes:</div>
        <ULdisc>
          <Li>
