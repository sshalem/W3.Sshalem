...
import O3_InstallRequirements from "./O3_InstallRequirements";
import O4_GitIgnore from "./O4_GitIgnore";
...
const o3_InstallRequirements = "3. Install requirements.txt";
const o4_GitIgnore = "4. (.gitignore) file";

// ===========================================
// == Update anchorList with  content menu  ==
// ===========================================

const anchorList: string[] = [o1_AddProjectToExistingGitRepo, o2_CloneGitPythonProject, o3_InstallRequirements, o4_GitIgnore];
...
const PythonGitMain = () => {
  ...
  return (
    <section>
      ...
      <O3_InstallRequirements anchor={o3_InstallRequirements} />
      <O4_GitIgnore anchor={o4_GitIgnore} />
